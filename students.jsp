					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-12">
							<ul class="nav navbar-nav w3_agile_nav">
								...
								<li class="active"> <a href="students.jsp"><span>Students</span></a></li>
			...
			<div class="gallery-top-grids">
				<div class="col-sm-3 gallery-grids-left">
					<div class="gallery-grid">
						<a class="example-image-link" href="images/s1.jpg" data-lightbox="roadtrip" data-title="Sundar Pichai">
				...
				<div class="col-sm-3 gallery-grids-left">
					<div class="gallery-grid">
						<a class="example-image-link" href="images/s2.jpg" data-lightbox="roadtrip" data-title="Ananth Ambani">
				...
				<div class="col-sm-3 gallery-grids-left">
					<div class="gallery-grid">
						<a class="example-image-link" href="images/s3.jpg" data-lightbox="roadtrip" data-title="Sathya Nadella">
				...
				<div class="col-sm-3 gallery-grids-left">
					<div class="gallery-grid">
						<a class="example-image-link" href="images/s4.jpg" data-lightbox="roadtrip" data-title="Bill Gates">
